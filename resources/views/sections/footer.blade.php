  ...
  <div class="sv-container">
    <div class="sv-footer__grid">
      ...
      <div>
        ...
        {{-- El Salvador flag stripe --}}
        <div class="sv-footer__flag" aria-label="El Salvador flag">
          <span style="background:#1B3A8A;"></span>
          <span style="background:#fff;"></span>
          <span style="background:#1B3A8A;"></span>
        </div>
        <div class="sv-social-links" style="margin-top:1rem;">
      ...
      <div>
        ...
        <ul class="sv-footer__links">
          <li><a href="{{ get_post_type_archive_link('property') }}">{{ __('All properties', 'sage') }}</a></li>
          <li><a href="{{ get_post_type_archive_link('property') }}?property_status=for-sale">{{ __('For sale', 'sage') }}</a></li>
          <li><a href="{{ get_post_type_archive_link('property') }}?property_status=for-rent">{{ __('For rent', 'sage') }}</a></li>
          <li><a href="{{ get_post_type_archive_link('property') }}?property_type=casa">{{ __('Houses', 'sage') }}</a></li>
          <li><a href="{{ get_post_type_archive_link('property') }}?property_type=apartamento">{{ __('Apartments', 'sage') }}</a></li>
          <li><a href="{{ get_post_type_archive_link('property') }}?property_type=terreno">{{ __('Land', 'sage') }}</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="sv-footer__links">
          ...
          <li><a href="{{ home_url('/privacy-policy') }}">{{ __('Privacy', 'sage') }}</a></li>
          <li><a href="{{ home_url('/terms') }}">{{ __('Terms', 'sage') }}</a></li>
        </ul>
        ...
        @if($whatsapp)
          <div style="margin-top:1.5rem;">
            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $whatsapp) }}"
               ...
               style="display:inline-flex;align-items:center;gap:0.5rem;background:#25D366;color:#fff;padding:0.6rem 1.2rem;border-radius:999px;font-size:0.82rem;font-weight:700;text-decoration:none;">
